...
namespace AppMartin.Controllers
{
    public class RespuestasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RespuestaID,Contenido")] Respuesta respuesta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RespuestaID,Contenido")] Respuesta respuesta)
        {
            if (ModelState.IsValid)
            {
